define(['leaflet', 'js/data', 'jquery'], function (L, Data, $) {
    ...
    LinkCity.prototype.bindEvents = function () {
        $("ul.province-dropdown li a").click(function(){
            var $nationButton = $(".nation-link .nation-dropdown .btn:first-child");
