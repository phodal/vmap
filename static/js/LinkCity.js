define(['leaflet', 'js/data', 'jquery'], function (L, Data, $) {
    ...
    LinkCity.prototype.bindEvents = function () {
        $(".nation-dropdown li a").click(function(){
